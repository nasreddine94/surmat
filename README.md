...
- `components/hero/earth.tsx` — the globe at the centre of the universe: NASA Blue Marble day imagery, city lights on the night side, relief, ocean glint, drifting clouds and an atmosphere halo (textures in `public/earth/`). Africa always faces the viewer; the globe leans at most 15° towards the cursor or a drag and never spins. Algeria and Senegal are traced in light (`lib/borders.ts`, Natural Earth 1:50m).
